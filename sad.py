...
parser.add_argument('--anc-data',type=str, dest = 'anc_data',default = 'support_files/SNPalleles_1000Genomes_allsites.txt')
...
if __name__ == '__main__':
	...
	anc_data = pd.read_csv(anc_data,sep = '\t')
	...
	popgwas['SE'] = popgwas['se'].astype(float)
	log.log('Done.\n')
